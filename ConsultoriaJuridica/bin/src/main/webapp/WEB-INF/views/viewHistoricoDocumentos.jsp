...
<!-- Esstos scripts se ocupan  -->
	...
	<script lenguaje="JavaScript" type="text/javascript" src="<c:url value="/resources/javascript/historicoDocumentos.js"/>"></script>
						...
						<div class="card">
							<div class="card-body">
								...
								<div width="50%">
									...
									<table class="table" id="tbl_histDocumentos">
										<thead class="bg-dark">
											<tr class="text-white">
												<th scope="col"></th>
								...
								<!--------------------------- INICIA Modal para registrar el nuevo documento ------------------------------------------>
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-body" id="contenido">
												...
												<div class="form-group" id="anexoUno">
													<strong><input id="documento" name="archivo" type="file" size="60"
														class="rojo" /></strong>
												</div>
											...
											<div class="modal-footer">
												...
												<button type="button" class="btn btn-primary" id="boton_guardarDocumento" onclick="click">Guardar</button>
											</div>
										</div>
									</div>
								</div>
